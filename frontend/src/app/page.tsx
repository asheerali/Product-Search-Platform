...
export default function DashboardPage() {
  ...
  const quickActions = [
    { href: "/scrape", icon: Upload, tint: "bg-sky-50 text-sky-600 dark:bg-sky-500/10 dark:text-sky-400", title: "Scrape Products", desc: "Upload PDFs, PPTX, XLSX, emails or provide a folder path." },
