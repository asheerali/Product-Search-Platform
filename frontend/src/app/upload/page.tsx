  ...
  return (
    <div className="max-w-3xl mx-auto">
      <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
        ...
        extraction pipeline, use the <Link href="/scrape-search?tab=scrape" className="text-sky-600 dark:text-sky-400 hover:underline">Extract Products</Link> tab instead.
      </p>
